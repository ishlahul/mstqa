...
WebUI.callTestCase(findTestCase('Pages/Login/Button Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Logout/Button Logout'), [:], FailureHandling.STOP_ON_FAILURE)

...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Update Alamat'), ['update_alamat' : ''], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Tap Button Simpan'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Verify Negative'), [('content') : 'Ubah Alamat'], FailureHandling.STOP_ON_FAILURE)

...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Lama'), ['pass_lama' : ''], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Baru'), ['pass_baru' : 'jeno0423'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Konfirm Pass'), ['pass_konfirm' : 'jeno0423'], FailureHandling.STOP_ON_FAILURE)

...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Lama'), [('pass_lama') : 'jeno1234'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Baru'), [('pass_baru') : 'jeno0423'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Konfirm Pass'), [('pass_konfirm') : 'jaemin0813'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Tap Button Simpan'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Page_UpdateProfil/android.widget.TextView - Kata sandi tidak sesuai'), 0)

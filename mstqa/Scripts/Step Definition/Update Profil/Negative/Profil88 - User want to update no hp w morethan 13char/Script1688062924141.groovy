...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Update No HP'), ['nomor_hp' : '08980423042308'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Tap Button Simpan'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Verify Negative'), [('content') : 'Ubah Nomor HP'], FailureHandling.STOP_ON_FAILURE)

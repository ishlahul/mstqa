...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Update Email'), [('update_email') : 'jeno111'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Tap Button Simpan'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Verify Negative'), [('content') : 'Ubah Email'], FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Page_UpdateProfil/Snackbar'), 0)

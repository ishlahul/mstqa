...
Mobile.callTestCase(findTestCase('Pages/Login/Input Password'), [('password') : 'jeno23'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Lama'), [('pass_lama') : 'jeno23'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Pass Baru'), [('pass_baru') : 'jeno1234jeno'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Update Profil/Input Konfirm Pass'), [('pass_konfirm') : 'jeno1234jeno'], FailureHandling.STOP_ON_FAILURE)
